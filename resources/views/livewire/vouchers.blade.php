    ...
    <x-modalform id="voucherEditModal" modalTitle="Edit Voucher" size="modal-xl">
        ...
        <x-slot name="button">
            <button type="button" class="btn btn-primary" data-bs-dismiss="modal"
                wire:click="store">Update</button>
            <button type="button" class="btn btn-danger" data-bs-dismiss="modal"
                wire:click="destroy">Delete</button>
        </x-slot>
    </x-modalform>

    <!-- Vouvher Status Modal -->
    <div wire:ignore.self class="modal fade" id="voucherStatusModal" tabindex="-1"
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            @error('voucherStatus.status') <span class="text-danger">{{ $message }}</span>
                                @endif
                            </div>
                            <div class="col-md-6">
        ...
        <div wire:ignore.self class="modal fade" id="jobOrderModal" tabindex="-1" aria-labelledby="jobOrderModalLabel"
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                @error('jobOrder.job_order_type') <span class="text-danger">{{ $message }}</span>
                                    @endif
                                </div>
                            </div>
                        </div>
            ...
            <div wire:ignore.self class="modal fade" id="expenseModal" data-bs-backdrop="static" data-bs-keyboard="false"
                tabindex="-1" aria-labelledby="expenseModalLabel" aria-hidden="true">
                                        ...
                                        <tr>
                                            <td class="d-flex flex-row">
                                                ...
                                                <select class="form-select"
                                                    wire:model.live="expenses.{{ $key }}.header_name">
                                                    <option value="">Select Header</option>
                                                    @foreach ($voucherHeader as $item)
                                                        <option value="{{ $item['header_name'] }}">{{ $item['header_name'] }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </td>
                                            <td style="width: 15%;">
                                                <input type="date" class="form-control"
                                                    wire:model.blur="expenses.{{ $key }}.expense_date">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control"
                                                    wire:model.blur="expenses.{{ $key }}.expense">
                                            </td>
                                            <td style="width: 15%;">
                                                <input type="number" class="form-control"
                                                    wire:model.blur="expenses.{{ $key }}.amount">
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
